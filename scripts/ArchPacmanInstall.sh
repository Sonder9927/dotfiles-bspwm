...
# Install arch-bspwm
pacman -S --noconfirm bspwm sxhkd polybar alacritty rofi feh picom neofetch yay
# Install language
pacman -S --noconfirm go cargo nodejs yarn lua
# Install software
pacman -S --noconfirm chromium firefox exa eva bat git-delta fd wget unzip rsync
yay -S --noconfirm just-git starship-git ripgrep-git tealdeer-git navi-git sac-git choose-git
# Install fnm
